...
function muro.saveBMP(filename, width, height, scaling, horizontal, vertical, characterTable, colorLookup, compress)
	 ...
	 if compress then
			...
			local bmpImage = bmpHeader .. bmpImage
			local compressedData = libdeflate:CompressDeflate(bmpImage)
